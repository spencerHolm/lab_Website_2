...
function loadStatsPage(){
	...
	var buffWin, buffLoss;
	var cell_value1, cell_value2;
	var row;
	...
	for(row = 2; row < table.rows.length; row++){
		...
		cell_value1 = parseInt(table.rows[row].cells[2].innerHTML);
		cell_value2 = parseInt(table.rows[row].cells[3].innerHTML);
		...
		else if(cell_value1 < cell_value2){
			table.rows[row].cells[4].innerHTML = table.rows[row].cells[1].innerHTML;
			buffLoss++;
		}
	}

	document.getElementById("wins").innerHTML = buffWin;
